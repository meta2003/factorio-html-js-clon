...
(function () {
  ...
  EN['item.rail-signal'] = 'Rail signal';
  EN['item.rail-signal.desc'] = 'Splits the track into blocks; an automatic train only passes it when the block beyond is free. Place next to a rail. Stack: 50.';
  EN['item.rail-chain-signal'] = 'Rail chain signal';
  EN['item.rail-chain-signal.desc'] = 'Like a rail signal, but also waits until the next signal after the block is green, so trains never stop inside a junction. Stack: 50.';
  ...
  EN['ent.rail-signal'] = 'Rail signal';
  EN['ent.rail-signal.desc'] = '1×1 next to a rail; the rail tile it faces becomes a block boundary. Green: the block beyond is free.';
  EN['ent.rail-chain-signal'] = 'Rail chain signal';
  EN['ent.rail-chain-signal.desc'] = '1×1 next to a rail; green only when the block beyond and the next signal out of it are both clear. Yellow: block free, exit red.';
  ...
  EN['tech.rail-signals'] = 'Rail signals';
  EN['tech.rail-signals.desc'] = 'Cost 100 automation + 100 logistic science packs, requires Automated rail transportation. Unlocks the rail signal and rail chain signal.';
  ...
  EN['status.wait_signal'] = 'Waiting at signal';
  EN['status.wait_train'] = 'Blocked by a train';
  EN['status.signal_green'] = 'Green: block free';
  EN['status.signal_red'] = 'Red: block occupied';
  EN['status.signal_yellow'] = 'Yellow: next signal red';
