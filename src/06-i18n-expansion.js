...
(function () {
  ...
  EN['item.roboport.desc'] = 'Charges and dispatches logistic robots within a 25-tile radius; also recharges you when nearby. Stack: 10.';
  ...
  EN['tech.logistic-robotics.desc'] = 'Cost 250 automation + 250 logistic + 250 chemical science packs. Unlocks the roboport, logistic robot and the three logistic chests.';
